...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while guessMade <= 8:
        ...
        if isWordGuessed(secretWord,lettersGuessed):
        ...
        elif guessMade == 8 and goodGuess != secretWord:
            ...
            letterLC = letter.lower()
            
            if letterLC in lettersGuessed:
                print("Oops! You've already guessed that letter:",getGuessedWord(secretWord,lettersGuessed))
            else:
                lettersGuessed.append(letterLC)
                availableLetters = getAvailableLetters(lettersGuessed)
                if isLetterGuessed(secretWord,letterLC):
                    goodGuess = getGuessedWord(secretWord,lettersGuessed)
                    print("Good guess:",goodGuess)
